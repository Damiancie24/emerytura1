    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // Console.Write("Podaj swoje imię: ");
            ...
            //imie = imie.Trim();
           imie =  Interaction.InputBox("Podaj Imie", "Emerytura" );
            ...
            nazwisko = Interaction.InputBox("Podaj Podaj nazwisko", "Emerytura");
            ...
            Interaction.MsgBox($"Masz: {wiek} lat.");
           ...
           // Console.WriteLine($"Masz: {wiek} lat."); // Preferowany zapis WrightLine , sklejania twkstu
            ...
            else
            {
                ...
                Interaction.MsgBox($"Do emerytury zostało ci {67 - wiek}");
            }
